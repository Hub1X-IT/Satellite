...
namespace NotoriousCreations.PlayerPrefsEditor
{
    ...
    public List<(string key, string type, string value, bool pinned)> items = new List<(string, string, string, bool)>();
    ...
    public void Refresh(List<(string key, string type, string value, bool pinned)> newItems)
    {
        items = newItems;
